      ...
      <div className={styles.container}>
        ...
        <section className={styles.successHero}>
          ...
          <div className={styles.heroMeta}>
            ...
            <div className={styles.metaItem}>
              <span>Abholung</span>
              <strong>
                {datumUndUhrzeit(bestellung.requestedTime)} Uhr
              </strong>
            </div>
          </div>
        </section>
        ...
        <div className={styles.contentGrid}>
                  ...
                  >
                    ...
                    <div className={styles.itemContent}>
                      ...
                      <div className={styles.itemCalculation}>
                        <span>
                          {position.quantity} ×{" "}
                          {formatPrice(position.unitTotal)}
                        </span>
          ...
          <aside className={styles.sideColumn}>
            <section
              className={`${styles.card} ${styles.pickupCard}`}
            >
              ...
              <div className={styles.pickupTime}>
                <strong>
                  {datumUndUhrzeit(bestellung.requestedTime)}
                </strong>
              ...
              <section className={styles.card}>
                ...
                <dl className={styles.infoList}>
                  ...
                  <div>
                    ...
                    <dd>
                      <a
                        href={`mailto:${bestellung.customer.email}`}
                      >
                  ...
                  <div>
                    ...
                    <dd>
                      <a
                        href={`tel:${bestellung.customer.phone}`}
                      >
            ...
            >
              ...
              {zahlung ? (
                ...
                <p className={styles.infoHint}>
                  Für diese Bestellung wurden keine Zahlungsdaten
                  hinterlegt.
                </p>
              )}
              ...
              <div className={styles.priceRows}>
                <div>
                  ...
                  <strong>
                    {formatPrice(bestellung.subtotal)}
                  </strong>
                </div>
                ...
                {liefergebuehr > 0 && (
                  <div>
                    ...
                    <strong>
                      {formatPrice(bestellung.deliveryFee)}
                    </strong>
                  </div>
                )}
                ...
                {rabatt > 0 && (
                  <div>
                    <span>Rabatt</span>
                    <strong>
                      − {formatPrice(bestellung.discountAmount)}
                    </strong>
                  </div>
                )}
                ...
                <div className={styles.totalRow}>
                  <span>Gesamt</span>
                  <strong>
                    {formatPrice(bestellung.totalAmount)}
                  </strong>
                </div>
              </div>
        ...
        <p className={styles.orderDate}>
          ...
          {datumUndUhrzeit(bestellung.orderedAt)} Uhr
        </p>
      </div>
    </main>
  );
